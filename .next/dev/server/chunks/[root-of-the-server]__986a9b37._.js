...
"[project]/Documents/MINE/edu-lead-pro-next/src/app/api/activity/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(request) {
    ...
    try {
        ...
        const activities = await __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$MINE$2f$edu$2d$lead$2d$pro$2d$next$2f$src$2f$lib$2f$models$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["ActivityLog"].find(query).sort({
            createdAt: -1
        }).limit(10).populate('userId', 'name');
        return __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$MINE$2f$edu$2d$lead$2d$pro$2d$next$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json(activities);
    } catch (err) {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__986a9b37._.js.map